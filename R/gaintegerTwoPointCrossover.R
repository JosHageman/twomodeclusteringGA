...
#'
#' @description Performs two-point crossover between two parent individuals in the
#' genetic algorithm, exchanging genetic material between two randomly selected points.
#'
...
gaintegerTwoPointCrossover <- function(object, parents, ...) {  
  ...
  crossOverPoint <- sort(sample.int(numCols, size = 2))
  
  swap <- c(1:crossOverPoint[1], crossOverPoint[2]:numCols)
